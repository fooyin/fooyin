function(windeployqt target)
    ...
    add_custom_command(
        ...
        POST_BUILD
        COMMAND
            $<IF:$<CONFIG:Debug>,${WINDEPLOYQT_DEBUG},${WINDEPLOYQT_RELEASE}> $<IF:$<CONFIG:Debug>,--debug,--release>
            ${WINDEPLOYQT_COMMON_ARGS} --dir "$<TARGET_FILE_DIR:${target}>" $<TARGET_FILE:${target}>
