...
public:
    ...
    void filesToCurrentPlaylist(const QList<QUrl>& urls, bool replace = false) const;
    void filesToNewPlaylist(const QString& playlistName, const QList<QUrl>& urls) const;
