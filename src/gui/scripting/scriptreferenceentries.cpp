...
const std::vector<ScriptReferenceEntry>& scriptReferenceEntries()
{
    ...
    static const std::vector Entries = {
        ...
        variableEntry(MetaData::TrackArtist, QT_TRANSLATE_NOOP("Fooyin", "Metadata"),
                      QT_TRANSLATE_NOOP("Fooyin", "Track artists not present in album artists")),
        ...
        variableEntry(MetaData::Loved, QT_TRANSLATE_NOOP("Fooyin", "Playback Statistics"),
                      QT_TRANSLATE_NOOP("Fooyin", "Love flag: 1 when loved, empty otherwise")),
        variableEntry(MetaData::LoveEditor, QT_TRANSLATE_NOOP("Fooyin", "Playback Statistics"),
                      QT_TRANSLATE_NOOP("Fooyin", "Interactive heart editor for the Love flag")),
        ...
        functionEntry("rand", u"$rand(min,max)"_s, QT_TRANSLATE_NOOP("Fooyin", "Returns a random number in range"),
                      QT_TRANSLATE_NOOP("Fooyin", "Numeric")),
        functionEntry("round", u"$round(value[,precision])"_s, QT_TRANSLATE_NOOP("Fooyin", "Rounds a numeric value"),
                      QT_TRANSLATE_NOOP("Fooyin", "Numeric")),
        functionEntry("greater", u"$greater(x,y)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Returns true when x is greater than y"),
        ...
        functionEntry("num", u"$num(value,length)"_s,
                      ...
                      QT_TRANSLATE_NOOP("Fooyin", "Numeric")),
        functionEntry("hex", u"$hex(value,length)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Formats a number in hexadecimal with leading zeroes"),
                      QT_TRANSLATE_NOOP("Fooyin", "Numeric")),
        ...
        functionEntry("regex_match", u"$regex_match(text,\"pattern\"[,group[,flags]])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Returns the first match or capture; group 0 is the full match"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("regex_matches", u"$regex_matches(text,\"pattern\",separator[,group[,flags]])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Returns all matches or captures; group 0 is the full match"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("regex_replace", u"$regex_replace(text,\"pattern\",replacement[,flags])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Replaces all regular expression matches; flags: i, m, s, x, U"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        ...
        functionEntry("substr", u"$substr(text,start,end)"_s, QT_TRANSLATE_NOOP("Fooyin", "Returns a substring"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("strstr", u"$strstr(text,needle[,start])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Finds the first substring position (1-based)"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("stristr", u"$stristr(text,needle[,start])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Finds the first substring position ignoring case (1-based)"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("strstrlast", u"$strstrlast(text,needle[,start])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Finds the last substring position (1-based)"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        ...
        functionEntry("longest", u"$longest(a,b,…)"_s, QT_TRANSLATE_NOOP("Fooyin", "Returns the longest string"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("shortest", u"$shortest(a,b,…)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Returns the first shortest string"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("strchr", u"$strchr(text,char)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Finds the first character position (1-based)"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("strrchr", u"$strrchr(text,char)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Finds the last character position (1-based)"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        ...
        functionEntry("stricmp", u"$stricmp(a,b)"_s, QT_TRANSLATE_NOOP("Fooyin", "Compares two strings ignoring case"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("regex_test", u"$regex_test(text,\"pattern\"[,flags])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Tests a regular expression match; flags: i, m, s, x, U"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("longer", u"$longer(a,b)"_s, QT_TRANSLATE_NOOP("Fooyin", "Returns true when a is longer than b"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("sep", u"$sep()"_s, QT_TRANSLATE_NOOP("Fooyin", "Returns the platform path separator"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        ...
        functionEntry("directory_path", u"$directory_path(path,level)"_s,
                      ...
                      QT_TRANSLATE_NOOP("Fooyin", "Path")),
        functionEntry("elide_end", u"$elide_end(text,width[,delim])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Elides text at the end"), QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("elide_mid", u"$elide_mid(text,width[,delim])"_s,
        ...
        functionEntry("cmdlink", u"$cmdlink(label,id)"_s,
                      ...
                      QT_TRANSLATE_NOOP("Fooyin", "Utility")),
        functionEntry("applink", u"$applink(label,application[,arguments[,directory]])"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Builds a clickable link that launches an application"),
                      QT_TRANSLATE_NOOP("Fooyin", "Utility")),
        functionEntry("urlencode", u"$urlencode(text)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Percent-encodes text for use in URLs"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        functionEntry("crc32", u"$crc32(text)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Returns the CRC-32 checksum of the text"),
                      QT_TRANSLATE_NOOP("Fooyin", "String")),
        ...
        functionEntry("if3", u"$if3(a1,a2,…,aN,else)"_s,
                      ...
                      QT_TRANSLATE_NOOP("Fooyin", "Conditional")),
        functionEntry("select", u"$select(index,a1,…,aN)"_s,
                      QT_TRANSLATE_NOOP("Fooyin", "Returns the value at the one-based index"),
                      QT_TRANSLATE_NOOP("Fooyin", "Conditional")),
