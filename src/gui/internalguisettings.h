...
enum GuiInternalSettings : uint32_t
{
    ...
    LibTreeSendPlayback     = 40 | Type::Bool,
    DirBrowserSendPlayback  = 41 | Type::Bool,
    EditableLayoutMargin    = 42 | Type::Int,
    PlaylistTabsAddButton   = 43 | Type::Bool,
    SplitterHandleSize      = 44 | Type::Int,
    LibTreeRestoreState     = 45 | Type::Bool,
    ShowTrayIcon            = 46 | Type::Bool,
    TrayOnClose             = 47 | Type::Bool,
    LibTreeKeepAlive        = 48 | Type::Bool,
    PlaylistTabsCloseButton = 49 | Type::Bool,
    PlaylistTabsMiddleClose = 50 | Type::Bool,
    PlaylistTabsExpand      = 51 | Type::Bool,
    LibTreeAnimated         = 52 | Type::Bool,
    PlaylistTabsClearButton = 53 | Type::Bool,
    LibTreeHeader           = 54 | Type::Bool,
    QueueViewerShowIcon     = 55 | Type::Bool,
    QueueViewerIconSize     = 56 | Type::Variant,
    QueueViewerHeader       = 57 | Type::Bool,
