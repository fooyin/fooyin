...
struct PortalShortcut
{
    ...
    bool operator==(const PortalShortcut&) const = default;
};
...
Q_DECLARE_METATYPE(Fooyin::GlobalHotkeys::PortalShortcut)
Q_DECLARE_METATYPE(Fooyin::GlobalHotkeys::PortalShortcutList)
