...
uint8_t convertU8ToU8(uint8_t inSample)
{
    return inSample;
}

int16_t convertU8ToS16(uint8_t inSample)
{
    return static_cast<int16_t>((inSample ^ 0x80) << 8);
}

int32_t convertU8ToS32(uint8_t inSample)
{
    return (static_cast<int32_t>(inSample ^ 0x80) << 24);
}

float convertU8ToFloat(uint8_t inSample)
{
    return (static_cast<float>(inSample) * (1.0F / static_cast<float>(0x80))) - 1.0F;
}

double convertU8ToDouble(uint8_t inSample)
{
    return (static_cast<double>(inSample) * (1.0 / static_cast<double>(0x80))) - 1.0;
}

uint8_t convertS16ToU8(int16_t inSample)
{
    return static_cast<uint8_t>(inSample >> 8 ^ 0x80);
}

int16_t convertS16ToS16(int16_t inSample)
{
    return inSample;
}

int32_t convertS16ToS32(int16_t inSample)
{
    return inSample << 16;
}

float convertS16ToFloat(int16_t inSample)
{
    return static_cast<float>(inSample) * (1.0F / static_cast<float>(0x8000));
}

double convertS16ToDouble(int16_t inSample)
{
    return static_cast<double>(inSample) * (1.0 / static_cast<double>(0x8000));
}

uint8_t convertS32ToU8(int32_t inSample)
{
    return static_cast<uint8_t>(inSample >> 24 ^ 0x80);
}

int16_t convertS32ToS16(int32_t inSample)
{
    return static_cast<int16_t>(inSample >> 16);
}

int32_t convertS32ToS32(int32_t inSample)
{
    return inSample;
}

float convertS32ToFloat(int32_t inSample)
{
    return static_cast<float>(inSample) * (1.0F / static_cast<float>(0x80000000));
}

double convertS32ToDouble(int32_t inSample)
{
...
uint8_t convertFloatToU8(float inSample)
{
...
int32_t convertDoubleToS32(double inSample)
{
    return convertToIntegral<double, int32_t>(inSample, 2147483648.0, std::numeric_limits<int32_t>::min(),
                                              std::numeric_limits<int32_t>::max());
}

float convertDoubleToFloat(double inSample)
{
    return static_cast<float>(inSample);
}

double convertDoubleToDouble(double inSample)
{
    return inSample;
}
...
AudioBuffer convert(const AudioBuffer& buffer, const AudioFormat& outputFormat, bool dither)
{
