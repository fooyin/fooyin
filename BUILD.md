...
* [libmpg123](https://www.mpg123.org/) - for the MP3 audio input plugin
...
sudo apt install \
    ...
    libflac-dev libmpg123-dev libsndfile1-dev libopenmpt-dev libgme-dev libarchive-dev libebur128-dev libcdio-dev \
...
sudo pacman -S --needed \
    ...
    taglib flac mpg123 libsndfile libopenmpt libgme libarchive libebur128 libcdio libcdio-paranoia soundtouch libsoxr
```
...
sudo dnf install \
    ...
    flac-devel mpg123-devel libsndfile-devel libopenmpt-devel game-music-emu-devel libarchive-devel libebur128-devel libcdio-devel \
